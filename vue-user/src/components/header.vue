	...
	<div class="headBack">
		<el-row class="container">
			<el-col :span="24">
				...
				<div class="mobileBox">
					<div class="hideMenu">
						<i class="fa fa-bars fa-fw" @click="pMenu=!pMenu"></i>
						<ul class="mlistmenu el-menu" v-show="!pMenu">
							...
							<li class="el-menu-item">
								<a href="/FriendsLink">友链</a>
							</li>
							<li class="el-menu-item" v-if="!haslogin">
	...
	<div class="headImgBox" :style="{backgroundImage:this.$store.state.themeObj.top_image?'url('+this.$store.state.themeObj.top_image+')':'url(static/img/headbg05.jpg)'}">
		...
		<div class="h-information">
			...
			<h2 class="h-description">
                        ...
                        {{this.$store.state.themeObj.autograph?this.$store.state.themeObj.autograph:"千山暮雪，海棠依旧"}}
...
export default {
	data() { //选项 / 数据
		return {
			userInfo: '', //用户信息
			haslogin: localStorage.getItem('userInfo') ? true : false, //是否已登录
			classListObj: '', //分类
